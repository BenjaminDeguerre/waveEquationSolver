...
/**
  * @class WESolver
  *
  * Class that represent a solver for the advection equation. Allow the user to specify the steps in time/space and the value of u.
  */
class WESolver {
...
public:
  ...
  /**
    * Constructor for WESolver. Initialize deltaT to 0.01, deltaX to 0.01 and u to 1.
    **/
  WESolver();
  ...
  /**
    ...
    *  </ul>
    *
    * @param initial The std::vector<double> of the initials values of the function to be estimated.
  ...
  /**
    ...
    **/
  std::vector<double> resolve(std::vector<double> initial, double t, int method);
...
private:
  ...
  std::vector<double> resolveUpwindExplicit(std::vector<double> initial, double t);
  std::vector<double> resolveUpwindImplicit(std::vector<double> initial, double t);
